...
class Client {
    ...
    public function CreateAccount(){
        ...
        echo "Your userName is: $this->UserName "." And Youre Bonus Balance is".$this->Balance."<br>";
    }
...
$clientObj = new Client("Josiane",3000000);
// $clientObj->CreateAccount();    aha nugukora konti;
$clientObj->SendMoney("alpha",2000000); // kohereza amafaranga 
